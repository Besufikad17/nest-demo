...
import { User, UserActivityLog } from 'generated/prisma/client';
...
describe('User Activity Module (e2e)', () => {
    ...
    describe('GET /user/activity/all', () => {
        it('should return activities for logged in user', async () => {
            ...
            const found = response.body.data.find((a: UserActivityLog) => a.id === activityId);
        ...
        it('should filter by action', async () => {
            ...
            expect(response.body.data.every((a: UserActivityLog) => a.action === UserActions.LOGIN_WITH_EMAIL)).toBe(true);
        });
    ...
    describe('GET /user/activity/admin/all', () => {
        ...
        it('should allow admin to filter by user', async () => {
            ...
            expect(response.body.data.every((a: UserActivityLog) => a.userId === standardUser.id)).toBe(true);
        });
